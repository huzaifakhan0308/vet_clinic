...
ALTER TABLE
    "medical_histories_treatments" ADD CONSTRAINT "medical_histories_treatments_treaments_id_foreign" FOREIGN KEY("treaments_id") REFERENCES "treatments"("id");
ALTER TABLE
    "medical_histories_treatments" ADD CONSTRAINT "medical_histories_treatments_medical_histories_id_foreign" FOREIGN KEY("medical_histories_id") REFERENCES "medical_histories"("id");
ALTER TABLE
